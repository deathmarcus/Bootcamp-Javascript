...
//   const users2 = new XMLHttpRequest();
//   users2.onload = (data) => {
//     console.log(data.target.responseText);
// };
// users2.open("GET", "https://dummyjson.com/users", false);
// users2.send();
  
//   const filterUSers = (str) => {
//     let strF = str.toLowerCase()
//     let usuariosFiltrados = users2.filter((user)=> {

//         if(
//             user.firstName.toLocaleLowerCase().match(strF) ||
//             user.lastName.toLocaleLowerCase().match(strF) ||
...
// let entrada = document.querySelector('.input_text');
